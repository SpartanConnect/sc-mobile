    ...
    render() {
        return (
            <ScrollView style={ styles.container }>
                ...
                <Switch style={{marginLeft: Dimensions.get('window').width/2 - 25, marginRight: Dimensions.get('window').width/2 - 25, paddingBottom: 0, transform: [{scaleX: 1.1}, {scaleY: 1.1}]}} onTintColor="red" thumbTintColor="gainsboro" onValueChange={(itemValue, itemIndex) => this.switchChange(itemValue)} value={this.state.switcher}/>
                </View>
            </ScrollView>
        );
    }
